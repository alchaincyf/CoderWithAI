...
export async function POST(request: Request) {
  ...
  if (origin && allowedOrigins.includes(origin)) {
    ...
    try {
      ...
      // 设置基础系统提示
      let systemPrompt = `你是CoderWithAI网站上一位充满激情、幽默感十足���AI编程导师。用户正在 ${currentPath} 页面与你聊天，所以他们的问题可能与这个页面有关。你的使命是让编程学习变得有趣又轻松！
  ...
  最后，别忘了保持幽默和热情。让用户感觉他们不仅在学习编程，更是在和一个有趣的朋友一起探索这个神奇的数字世界！`;
      ...
      2. 鼓励良好的编���习惯，就像鼓励人保持良好的个人卫生一样重要（没人喜欢臭臭的代码，对吧？）。
