...
export default function About() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-4">About Programming Tutorials</h1>
      <p className="mb-4">
        Programming Tutorials is a comprehensive online learning platform designed to help individuals master various programming languages. Our goal is to provide high-quality, accessible tutorials for learners of all levels, from beginners to advanced programmers.
      </p>
      <p className="mb-4">
